export function generateRandomQuote() {
  const quotes = [
    "Três coisas que eu não posso perder: TEMPO, FÉ E OPORTUNIDADE",
    ...
    "Quando tudo parece estar indo contra você, lembre-se que o avião decola contra o vento e não a favor dele (Henry Ford)",
    ...
    "Só você é responsável pelo teu futuro! faça suas escolhas",
    "ESCOLHAS",
    "Destrua a Ponte!",
    "Queime os navios!",
    "Não Tenhas medo!",
    ...
    "É normal nos chatearmos ou nos decepcionarmos com as pessoas, portanto crie o hábito da reconciliação. (Mateus 5:23-24)",
    "Tenha sempre uma visão clara de no mínimo 3 meses, clareza no caminho determina as suas ações. (Provérbios 21:5)",
    "Crie o hábito de modelar o que já deu certo. Certamente você deve ter alguém em quem se espelha, extraia desta pessoa comportamentos e atitudes que a fizeram chegar onde chegou. (Efésios 5:1-2)",
